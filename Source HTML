  ...
  <div class="card active" id="step-1">
    ...
    <div class="question-block">
      ...
      <div class="options" id="q1-tasks">
        <label class="option">
          <input type="checkbox" value="intake" />
  ...
  <div class="card" id="step-3">
    ...
    <div class="question-block">
      ...
      <div class="options" id="q3-types">
        <label class="option"><input type="checkbox" value="foster" /><span class="option-check"></span><span class="option-text"><span class="option-title">Foster care adoptions</span></span></label>
        <label class="option"><input type="checkbox" value="newborn" /><span class="option-check"></span><span class="option-text"><span class="option-title">Newborn / infant adoptions</span></span></label>
        <label class="option"><input type="checkbox" value="contested" /><span class="option-check"></span><span class="option-text"><span class="option-title">Contested adoptions</span></span></label>
        <label class="option"><input type="checkbox" value="icwa" /><span class="option-check"></span><span class="option-text"><span class="option-title">ICWA matters</span></span></label>
        <label class="option"><input type="checkbox" value="international" /><span class="option-check"></span><span class="option-text"><span class="option-title">International re-adoptions</span></span></label>
        <label class="option"><input type="checkbox" value="guardianship" /><span class="option-check"></span><span class="option-text"><span class="option-title">Guardianships</span></span></label>
      </div>
    </div>
  ...
  <div class="card" id="step-6">
    ...
    <div class="question-block">
      ...
      <div class="options" id="q6-time">
        <label class="option"><input type="checkbox" value="more-clients" /><span class="option-check"></span><span class="option-text"><span class="option-title">Taking on more clients or cases</span></span></label>
        <label class="option"><input type="checkbox" value="complex" /><span class="option-check"></span><span class="option-text"><span class="option-title">Spending more time on complex or contested matters</span></span></label>
        <label class="option"><input type="checkbox" value="cx" /><span class="option-check"></span><span class="option-text"><span class="option-title">Improving the client experience</span></span></label>
        <label class="option"><input type="checkbox" value="marketing" /><span class="option-check"></span><span class="option-text"><span class="option-title">Marketing and growing the practice</span></span></label>
        <label class="option"><input type="checkbox" value="training" /><span class="option-check"></span><span class="option-text"><span class="option-title">Training or developing staff</span></span></label>
        <label class="option"><input type="checkbox" value="balance" /><span class="option-check"></span><span class="option-text"><span class="option-title">Personal time — work-life balance could be better</span></span></label>
      </div>
    </div>
